...
class Normal {
	...
	force() {
		...
		if(arguments[0] instanceof Grain &&
			...
			console.log(
				Vect3.dot(r12, n[0]).toFixed(3),
				Vect3.dot(r12, n[1]).toFixed(3),
				Vect3.dot(r12, n[2]).toFixed(3),
				Vect3.dot(r12, n[3]).toFixed(3),
				Vect3.dot(r12, n[4]).toFixed(3),
				Vect3.dot(r12, n[5]).toFixed(3),
				j,
				Vect3.dot(r12, n[j]).toFixed(3)
			);
			...
			if(j > 100) {
				...
				var ksi = Math.max(0, 0.5 * D1 - h12) * 1;
