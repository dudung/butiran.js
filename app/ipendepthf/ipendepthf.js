/*
	ipendepthf.js
	Intruder penetration depth in fluid immersed bed particle
	
	Sparisoma Viridi | https://github.com/dudung/butiran
	
	Include: <script src="ipendepthf.js"></script> in a HTML fie
	Execute: Refresh web browser viewing the HTML file
	
	20190428 Beg from fdraglam.js in 0027.
	1606 Try to delete element related to flow.
	1627 Fix dissipation part of soft sphere collision scheme.
	1645 Add intruder parameters
	1728 Update OSF after solving a conflct from 0033.
	1748 Add feature of intruder vertical position.
	1852 Fin color for intruder and final conf.
	1857 Add title time.
	1947 Change viewFinConf to viewConf.
*/
...
var diai, rhoi, Tint, zint, INTRUDER_CREATED;
...
function buttonClick() {
	...
	if(cap == "Load") {
		...
		tout(taOut1, "ipendepthf.js -- 20190428\n"
			+ "Intruder penetration depth in fluid "
			+ "immersed bed particle\n"
			+ "Sparisoma Viridi | "
